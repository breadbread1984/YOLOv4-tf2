...
def main():
  ...
  yolov4.compile(optimizer = tf.keras.optimizers.Adam(1e-5), loss = {'output1': lambda labels, outputs: loss1([outputs, labels]),
  ...
  yolov4.fit(trainset, epochs = 100, validation_data = testset);
